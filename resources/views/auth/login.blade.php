...
<html>
    <head>
        ...
        <link rel="icon" href="{{asset('storage/'.$logoweb->value)}}" type="image/x-icon"> <!-- Favicon-->
                ...
                <div class="login_header blue_lgel">
                    <ul class="login_branding">
                        ...
                        <div class="logo_small">
                            <img src="{{asset('storage/'.$logoweb->value)}}" width="70" height="35" alt="bingo">
                        </div>
                        <span>Plantation Information System</span>
                        </li>
