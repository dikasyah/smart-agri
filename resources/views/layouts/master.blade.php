...
<html>
    <head>
        ...
        <link rel="icon" href="{{asset('storage/setting/logo.png')}}" type="image/x-icon"> <!-- Favicon-->
        ...
        <div id="left_bar">
            <div id="primary_nav" class="g_blue">
                <ul>
                    ...
                    <li><a href="/console/tanaman" title="Tanaman"><span class="icon_block m_book">Tanaman</span></a></li>
                    <li><a href="/console/plantation" title="Plantation"><span class="icon_block m_map">Plantation</span></a></li>
                    <li><a href="/console/sensor" title="Sensor"><span class="icon_block m_events">Sensor</span></a></li>
                    <li><a href="/console/report" title="Report"><span class="icon_block m_media">Report</span></a></li>
            ...
            <div id="start_menu">
                <ul>
                    ...
                    <ul class="black_gel">
                        ...
                        <li><a href="/console/tanaman"><span class="list-icon book_b">&nbsp;</span>Tanaman<span class="mnu_tline">Tagline</span></a></li>
                        <li><a href="/console/plantation"><span class="list-icon map_b">&nbsp;</span>Plantation<span class="mnu_tline">Tagline</span></a></li>
                        <li><a href="/console/sensor"><span class="list-icon list_images_b">&nbsp;</span>Sensor<span class="mnu_tline">Tagline</span></a></li>
                        <li><a href="/console/report"><span class="list-icon folder_b">&nbsp;</span>Report<span class="mnu_tline">Tagline</span></a></li>
            ...
            <div id="sidebar">
                <div id="secondary_nav">
                    <ul id="sidenav" class="accordion_mnu collapsible">
                        ...
                        <li>
                            <a href="#" class=""><span class="nav_icon user"></span> Account<span class="up_down_arrow">&nbsp;</span></a>
                            <ul class="acitem" style="display: none;">
                                <li><a href="/console/user"><span class="list-icon">&nbsp;</span>User</a></li>
                                <li><a href="/console/role"><span class="list-icon">&nbsp;</span>Role</a></li>
                                <li><a href="/console/permission"><span class="list-icon">&nbsp;</span>Permission</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="/console/tanaman"><span class="nav_icon book"></span> Tanaman</a>
                        </li>
                        <li>
                            <a href="/console/plantation"><span class="nav_icon map"></span> Plantation</a>
                        </li>
                        <li>
                            <a href="/console/sensor"><span class="nav_icon list_image"></span> Sensor</a>
                        </li>
                        <li>
                            <a href="/console/report"><span class="nav_icon folder"></span> Report</a>
                        </li>
                        <li>
        ...
        <div id="container">
            <div id="header" class="blue_lin">
                <div class="header_left">
                    <div class="logo">
                        <img src="{{asset('storage/setting/logo.png')}}" width="120" height="60" alt="PIS">
                    </div>
                    <div id="responsive_mnu">
                        ...
                        <div id="responsive_menu" class="hidden">
                            <ul>
                                ...
                                <li><a href="/console/tanaman"> Tanaman</a></li>
                                <li><a href="/console/plantation"> Plantation</a></li>
                                <li><a href="/console/sensor"> Sensor</a></li>
                                <li><a href="/console/report"> Report</a></li>
            ...
            <div class="switch_bar">
                <ul>
                    ...
                    <li>
                        <a href="/console/tanaman">
                            <span class="stats_icon administrative_docs_sl"></span>
                            <span class="label">Tanaman</span>
                        </a>
                    </li>
                    <li>
                        <a href="/console/plantation">
                            <span class="stats_icon archives_sl"></span>
                            <span class="label">Plantation</span>
                        </a>
                    </li>
                    <li>
                        <a href="/console/sensor">
                            <span class="stats_icon calendar_sl"></span>
                            <span class="label">Sensor</span>
                        </a>
                    </li>
                    <li>
                        <a href="/console/report">
